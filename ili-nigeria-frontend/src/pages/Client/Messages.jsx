...
const Messages = () => {
  ...
  // Check URL for linked order ID (e.g., from OrderDetails page)
  useEffect(() => {
  ...
  // Load the first thread by default if no thread is active
  useEffect(() => {
  ...
  const handleCreateNewThread = () => {
    ...
    setNewThreadBody("");
    setNewThreadOrderLink("");
    // In a real app: call API to create new thread
  };
      ...
      <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="p-10 space-y-4 text-center bg-white border border-gray-200 shadow-lg rounded-xl">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 mx-auto font-semibold text-white transition-all rounded-lg shadow-md bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800"
          >
    ...
    <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <header className="flex items-center justify-between pb-6 border-b border-gray-200">
        <h1 className="flex items-center gap-3 text-3xl font-bold text-gray-900">
          <MessageSquare className="text-blue-600 w-7 h-7" /> Support Inbox
        </h1>
        <button
          onClick={() => setShowNewThreadModal(true)}
          className="flex items-center gap-2 px-4 py-2 font-semibold text-white transition-all rounded-lg shadow-md bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800"
        >
              ...
              <div className="p-5 bg-white border-t border-gray-200">
                <div className="flex gap-3">
                  <textarea
                    ...
                    className="flex-1 p-3 border border-gray-300 rounded-lg resize-none focus:border-blue-500 focus:ring-blue-500"
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 font-semibold text-white transition-all rounded-lg shadow-md bg-blue-600 hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center"
                  >
                ...
                {activeThread.status === "Closed" && (
                  <p className="flex items-center gap-1 mt-2 text-sm text-red-600">
                    <AlertCircle className="w-4 h-4" /> This thread is closed.
                    Please start a new message for further inquiries.
                  </p>
                )}
              </div>
            </>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:border-blue-500"
              />
            </div>
